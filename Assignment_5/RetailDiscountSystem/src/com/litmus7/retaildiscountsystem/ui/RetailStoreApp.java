...
/**
 * Main application that takes user input of type of customer and prints details
 */
public class RetailStoreApp {

	/**
	 * @param args takes customer type and total amount, and prints details such as
	 *             discount applied and final amount to be paid.
	 */
